...
While most results in this section concern the Burhat order defined in Section~\ref{sec:bruhat}, another widely used order on $S_{n}$ is the (left) weak order $\le_{L}$ (for example, see~\cite{A,B,C}).  This order is generated by the covering relations
\[
