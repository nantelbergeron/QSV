...
\Nantel{what you think of remark below? Well it is not a lattice.} 
  \begin{rem}
   The order $(S_{n}/\!\!\sim,\le_{L})$ is closely related to the Tamari lattice, also known as the associahedron~\cite{Tamari}. 
