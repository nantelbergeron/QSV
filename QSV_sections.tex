...
\begin{rem}
In~\cite{Reading}, Reading defines a collection of quotients on the weak order of $S_{n}$.  
The fibers of his map are intervals in the weak order with distinguished bottom and top elements---known as $c$-sortable and $c$-antisortable elements---which include as a special case the $312$-avoiding permutations.  
While this work is a natural point of comparison for our results, there does not appear to be a direct connection between the two.  
Nonetheless, the similarities are remarkable and warrant further investigation.
\end{rem}
