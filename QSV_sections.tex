...
\lucas{Why not \\ ``M.~Zabrocki'' \\ and \\ ``R.~Gonz\'alez D'L\'eon?''}
...
\Nantel{I re-wrote the remark about Hilbert series correctly.}
...
\Nantel{we need to write the remark below properly and test it.}
\begin{rem}
 Remark about polynomial vanishing on the $\omega_0 \QSV_n\omega_0$ obtained from the $P_\alpha$ and mention that the top homogenious component is invariants.
\end{rem}
