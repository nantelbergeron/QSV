...
\Lucas{I got confused and I am not sure what these remarks should say any more.  (Original remark is commented out below).}

\Nantel{I am here!  Things not to forget:

 \ 
 
 I added remarks about automorphism and dual def of exc-classes. I will add one last remark at the end of Section 6 stating that we can apply the reverse of the variable to the $P_\alpha$ to obtain that
 we have vanishing polynomial for the dual notion of excedance. The top homogeneous part (being quasisymmetric) is invariant by such transformation. 
 
 \
 
 I removed all mention to weak order. This all go in a subsequent paper!}


\begin{rem}
\begin{enumerate}
\item New remark about Hilbert series and/or weak order?

\item Remark about reversal.
...
\Lucas{What do you think of this section?}
