...
Theorem~\ref{thm:excedancequotient} and Corollary~\ref{cor:interval} show that the excedance classes partition the Bruhat order of $S_n$ in intervals and the quotient $S_n\big/\!\!\sim$ is a 
...
The (left) weak ordering on $S_n\big/\!\!\sim$ is generated by the  covering relation
 ...
 This is a well defined suborder of the Bruhat order on $S_n\big/\!\!\sim$
